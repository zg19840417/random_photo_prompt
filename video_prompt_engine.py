...
VIDEO_SCOPE_ORDER = ("head", "upper_body", "full_body", "large_half_body", "half_body")
...
VIDEO_ACTION_OPTIONS = {
    ...
    "upper_body": {
        "hand_chest": (
            "她从当前上半身姿态开始，先抬眼直视镜头，肩膀微微向前送出，右手从发侧滑到耳后，左手停在锁骨旁边，随后右手沿颈侧滑到锁骨，左手移到胸前边缘，胸口随呼吸明显起伏，上半身继续向镜头前倾，头发从肩侧滑落，镜头缓慢推近，眼神变得更主动，最后停在半低头抬眼的挑逗笑容。",
            "她先侧脸停顿，眼神从画面边缘转回镜头方向，右手撩开脸侧头发，左手从颈侧滑到锁骨，肩线跟着身体前倾向镜头靠近，胸口上方随呼吸起伏，右手指尖停在锁骨中央，头发被甩到一侧，光影从肩头滑到胸口上方，嘴唇微张，最后露出得意笑并停住。",
        ),
        "shoulder_turn": (
            "她从当前上半身姿态开始，先低头看向镜头下方，随后慢慢抬眼，把右肩向镜头方向转出，左肩轻轻后收，锁骨线条跟着转动，胸口上方随着前倾更靠近画面，右手从发尾滑到肩头，头发向一侧甩开，镜头做很小的侧向移动，眼神变成轻微嘲笑，最后停在肩线一高一低的姿态。",
        ),
    },
    "half_body": {
        "waist_turn": (
            "她从当前半身姿态开始，头部先转向镜头，眼神锁住画面中心，随后上半身明显前倾，右肩向前压近，腰线向左侧扭动，右手从锁骨滑到腰侧，左手扶住右侧腰线，身体重心慢慢向镜头靠近，头发跟着前倾晃动，镜头同步推近，嘴角从冷淡变成挑衅笑，最后贴近镜头停住。",
            "她先向后仰出胸口和腰部曲线，眼神仍然直盯镜头，随后身体向镜头方向回压，肩膀先转回正面，胸线跟着靠近画面，腰线再向侧面扭出弧度，右手沿腰侧向下移动，左手从发侧滑到肩头，头发在回压时轻轻甩动，光影沿腰线滑过，最后停在轻蔑又勾人的半身姿态。",
        ),
        "near_camera": (
            "她从当前半身姿态开始，先用眼神锁住镜头，随后腰部带动上半身靠近，右手向镜头前景伸出形成近大远小，指尖短暂占据画面前方，左手停在腰侧，肩膀跟着向前压近，头发从背后滑到胸前，镜头略微后退再推近，嘴角慢慢上扬，最后身体停在更靠近镜头的位置。",
        ),
    },
    "large_half_body": {
        "hip_leg": (
            "她从当前大半身姿态开始，先把重心移到左腿，右腿向镜头前方伸出形成强透视，膝盖和小腿靠近画面前景，随后腰胯向右侧转动，右手扶住腰线，左手撩开头发，肩膀跟着向镜头前倾，头发在转动时甩到一侧，腿部前景保持近大远小，镜头沿腿部方向轻轻推进，最后抬眼直视镜头并露出得意笑。",
            "她先低头停顿，随后抬眼看向镜头，左腿弯曲承重，右腿向画面前景伸出，脚背和小腿形成明显前景，腰线跟着右腿方向转动，臀部侧面轮廓随重心移动改变，右手沿腰侧停住，左手从发侧滑到肩头，上半身慢慢前倾，光影从大腿滑到腰侧，最后嘴角带挑衅笑容。",
        ),
        "body_wave": (
            "她从当前大半身姿态开始，肩膀先向左侧下压，腰线随后向右侧摆动，臀部跟着转向镜头，大腿线条随重心改变角度，右手沿腰侧缓慢移动，左手停在发侧，头发被身体摆动带起，镜头小幅环绕到更正面的角度，眼神从低垂变成主动直视，最后身体靠近镜头并停住。",
        ),
    },
    "full_body": {
        "step_turn": (
            "她从当前全身姿态开始，先从侧身慢慢转向镜头，眼神提前锁住画面中心，随后左腿承重，右腿向镜头方向迈近一步，上半身跟着前倾，肩线和腰线一起扭动，右手撩开头发，左手扶住腰侧，头发和配饰随着转身晃动，镜头同步向前推进，光影沿腿线和腰侧移动，最后抬起下巴露出挑衅笑容。",
            "她先用眼神锁定镜头，身体保持完整入画，随后左腿承重，右腿向前点地，腰线慢慢转向镜头，肩膀跟着回到正面，右手从发侧滑到腰侧，左手抬起制造手臂曲线，头发被手臂动作带动，镜头从脚下方向轻轻上推，最后停在更强势的全身展示姿态。",
        ),
        "lying_recline": (
            "她从当前横向全身姿态开始，先侧身抬眼看向镜头，右手撑住支撑面，随后肩背离开支撑面，腰线向镜头方向卷起，右腿轻轻伸展带动身体转动，左腿保持弯曲形成层次，头发铺开后向一侧滑动，镜头沿身体横向轻轻移动，光影从肩背滑到腰侧，最后上半身靠近镜头并露出挑逗笑容。",
        ),
        "forced_perspective": (
...
ACTION_PRIORITY_BY_SCOPE = {
    ...
    "upper_body": ("hand_chest", "shoulder_turn"),
    "half_body": ("waist_turn", "near_camera"),
    "large_half_body": ("hip_leg", "body_wave"),
...
FORBIDDEN_BY_SCOPE = {
    ...
    "upper_body": ("全身", "臀", "腿", "脚", "走", "迈"),
    "half_body": ("全身", "脚", "脚尖", "脚掌", "走", "迈近一步"),
    "large_half_body": ("脚掌", "脚尖", "从头到脚"),
}
...
def normalize_video_seconds(value, default: int = 10) -> int:
    try:
        seconds = int(value)
...
def _action_keys_for(scope: str, pose_family: str) -> tuple[str, ...]:
    keys = ACTION_PRIORITY_BY_SCOPE.get(scope) or ACTION_PRIORITY_BY_SCOPE["upper_body"]
...
def generate_video_action(
    ...
    scope = infer_video_scope(source_prompt) or "upper_body"
    ...
    options = VIDEO_ACTION_OPTIONS.get(scope, VIDEO_ACTION_OPTIONS["upper_body"]).get(action_key)
    if not options:
        options = VIDEO_ACTION_OPTIONS["upper_body"]["hand_chest"]
...
def _split_action_clauses(action_text: str) -> list[str]:
    ...
    if len(clauses) <= 1:
        clauses = [part.strip(" ，,。；;") for part in re.split(r"(?:随后|然后|接着|最后|再)", text) if part.strip(" ，,。；;")]
...
def stage_video_action(action_text: str, seconds: int | str = 10, scope: str = "") -> str:
    seconds = normalize_video_seconds(seconds)
    ...
    if not extras:
        for candidate_scope, markers in VIDEO_SCOPE_MARKERS.items():
            if any(marker in action_text for marker in markers):
                ...
                break
    while len(clauses) < stage_count and extras:
...
def video_prompt_from_action(
    ...
    if not text:
        ...
        text = stage_video_action(text, resolved_seconds, infer_video_scope(source_prompt))
