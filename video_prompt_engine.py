...
NSFW_ACTION_OPTIONS = {
    "head": {
        "oral_hand": (
            "延续参考图的头肩构图与人物位置，男人站位与阴茎入画方向保持一致，他的粗长匀称、形状正常的阴茎始终清晰可见，圆润饱满的龟头、清晰冠状沟、挺直柱身与自然青筋完整。"
            "女孩双手继续缓慢套弄他的柱身，舌尖在他的龟头与冠状沟间小幅舔弄，偶尔将他的龟头轻含再退出，口水拉出细丝。"
            "眼神从略低处慢慢抬回镜头，嘴角保持高冷浅笑，头部与肩线稳定，镜头固定。",
            "延续参考图的近景构图，男人站位与阴茎从画面底部伸出的关系保持一致，他的形状正常的阴茎完整可见、形态清晰。"
            "女孩嘴唇含住他的冠状沟小幅度前后移动，一手在中下段缓慢撸动，舌尖点触他的马眼。"
            "半眯眼睛看向镜头，呼吸让唇部水光轻微闪动，身体位置稳定。",
        ),
    },
    "half_body": {
        "oral_hand": (
            "延续参考图的半身构图与人物位置，男人站在身前的站位和阴茎入画方向保持一致，他的粗长匀称、形状正常的阴茎始终入镜，龟头圆润、柱身挺直、青筋自然，根部连着他的下腹。"
            "女孩跪姿或前倾姿态延续，双手继续上下缓慢套弄，低头将他的龟头轻含再吐出，再回到套弄节奏。"
            "偶尔抬眸看镜头，表情高冷湿润，腰肩动作小幅稳定，镜头稳定。",
            "延续参考图景别与主体关系，阴茎位置与根部可见范围保持一致，解剖正常、形态清晰。"
            "女孩一手握他的根部固定，另一手环住他的柱身缓慢撸动，同时舌尖舔弄他的龟头侧面，口水顺柱身滑落。"
            "身体重心稳定，手部与嘴唇做连续小幅动作，最后眼神落回镜头。",
        ),
    },
    "full_body": {
        "oral_hand": (
            "延续参考图的全身构图，脚膝支撑点与人物位置稳定，男人站立双腿分开的站位保持一致，他的粗长匀称、形状正常的阴茎完整清晰入镜，根部连着他的下腹。"
            "女孩保持跪姿，双手继续缓慢套弄他的柱身，间或低头含住他的龟头轻吸再退出，动作幅度小、节奏稳定。"
            "上身仅有轻微起伏，最后抬眼看向镜头，高冷表情。",
            "延续参考图全身关系，阴茎入画方向与可见根部保持一致，形状正常、形态清晰，手指数量正常。"
            "女孩双手交替套弄他的柱身，舌尖扫过他的马眼，头发随低头小幅滑动，膝与脚位置固定。"
            "镜头稳定，画面结束于她半眯眼看镜头的瞬间。",
        ),
    },
}

NSFW_STABILITY_SUFFIX = (
    "构图与主体关系稳定，阴茎形状正常、形态清晰，手指与手部动作自然，口交与手部套弄节奏连贯。"
)
