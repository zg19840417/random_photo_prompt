...
_EXPRESSION_BOOST_BY_SCALE = {
    "normal": ("眼尾弯起，嘴角自然上扬", "嘴角自然上扬眼神明亮", "嘴唇自然展开嘴角微扬"),
    "bold": ("眼尾弯起，嘴角明显上扬，带俏皮挑衅笑容", "嘴角勾起一抹俏皮笑意眼神明亮直接", "嘴唇轻扯出挑衅弧度眼尾带笑", "嘴角上扬露出俏皮坏笑神情勾人"),
    "nsfw": ("眼尾弯起，嘴角明显上扬，带放肆挑衅坏笑", "嘴角勾起放肆坏笑喘气声在安静中格外清晰", "眼尾泛红嘴角带情欲满足的笑", "嘴唇微张嘴角挑起危险又满足的坏笑"),
}
