...
SHOT_OUTFIT_OPTIONS = {'normal': {'head_shot': ['银色耳饰和湖蓝色发夹靠近脸侧，颈侧有一条细小项链', '薄荷绿发夹固定黑色发丝，耳垂有小颗珍珠耳饰', '珊瑚粉丝巾边缘贴近肩颈，耳饰在阳光下轻微发亮'], 'half_body': ['珊瑚粉短上衣搭配湖蓝色高腰短裤，配一枚细小银色耳饰', '天空蓝运动短上衣搭配白色百褶短裙，手腕有彩色细手链']}, 'bold': {'head_shot': ['细银项链贴近颈侧，湖蓝色耳饰和透明手套指尖靠近脸部', '玫粉色发夹固定黑色发丝，细银耳饰和颈侧小链条贴近脸侧', '湖蓝色指甲停在唇边，耳饰和发丝高光贴近脸侧'], 'half_body': ['亮黄色轻薄短上衣搭配薄荷绿高腰短裤，透明手套边缘贴近手腕', '玫粉色亮面细吊带搭配天空蓝短裙，腰侧有一条细银链']}}
